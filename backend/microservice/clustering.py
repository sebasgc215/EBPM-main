...
def cluster_user_stories(user_stories):
    ...
    for story in user_stories:
        ...
        dependency_vectors = [model.infer_vector([dep['name']]) for dep in story.get('dependencies', [])]
    ...
    for i, (story_vector, story) in enumerate(zip(padded_story_vectors, user_stories)):
        clusters[cluster_labels[i]].append((story['id'], story['name'], story['points'], story['dependencies']))
